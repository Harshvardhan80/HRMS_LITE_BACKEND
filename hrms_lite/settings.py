...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS', 
    default='hrms-lite-backend-6kgv.onrender.com,localhost,127.0.0.1'
).split(',')
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:3000,http://127.0.0.1:3000,https://hrms-lite-frontend-five.vercel.app/'
).split(',')
